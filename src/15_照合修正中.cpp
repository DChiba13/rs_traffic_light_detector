...
constexpr double CAMERA_RESOLUTION_H = (70.4 / 1280.0) * DEG_TO_RAD; // カメラの1[pix]あたりの角度[rad]
constexpr double CAMERA_RESOLUTION_V = (43.3 / 720.0) * DEG_TO_RAD; // カメラの1[pix]あたりの角度[rad]
                      ...
                      vector<int> &pts1_x_region, vector<int> &pts1_y_region, vector<int> &pts2_x_region, vector<int> &pts2_y_region)
{
  ...
  for(int label = 0; label < object_reflect_id; label++)
  {
    ...
    cout << "CAMERA_RESOLUTION_H[rad] : " << CAMERA_RESOLUTION_H << endl;
    cout << "CAMERA_RESOLUTION_V[rad] : " << CAMERA_RESOLUTION_V << endl;
    cout << "CAMERA_RESOLUTION_H[deg] : " << CAMERA_RESOLUTION_H * 180 / M_PI<< endl;
    cout << "CAMERA_RESOLUTION_V[deg] : " << CAMERA_RESOLUTION_V * 180 / M_PI<< endl;
    ...
    // cv::rectangle(camera_img, rect_region, Scalar(0, 255, 0), 2);
  }
}
...
int main(int argc,char **argv){
  ...
  while (true)
  {
    ...
    for(int region_num = 0; region_num < pts1_x_region.size(); region_num++)
    {
      ...
      // cout << "pts1_x_region.size() : " << pts1_x_region.size() << endl;
      ...
      // cout << "pts2_x_region[" << region_num << "] : " << pts2_x_region[region_num] << endl;
      // cout << "pts2_y_region[" << region_num << "] : " << pts2_y_region[region_num] << endl;
